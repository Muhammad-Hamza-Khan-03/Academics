			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +921234446457</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> eeshahai@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i>Lahore</a></li>
					</ul>
                               ...
                               <div class="dropdownn">
                                ...
                                <div class="dropdownn">
								  ...
								  <div class="dropdownn-content">
                                    ...
                                    <a href="reg.php"><i class="fa fa-user-plus" aria-hidden="true"></i>Register Admin</a>
                                  </div>
                                </div>';
